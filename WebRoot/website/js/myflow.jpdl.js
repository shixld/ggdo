...
$.extend(true,myflow.config.tools.states,{
		start : {
			...
			fork : {showType: 'image',type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : 'img/48/for.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			ifc : {showType: 'image',type : 'ifc',
				name : {text:'<<ifc>>'},
				text : {text:'合并'},
				img : {src : 'img/48/if.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			mail : {showType: 'image',type : 'mail',
				name : {text:'<<mail>>'},
				text : {text:'邮件'},
				img : {src : 'img/48/task_mail.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'邮件'},
					temp1: {name:'temp1', label: '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.inputEditor();}}
				}},
			log : {showType: 'image',type : 'log',
				name : {text:'<<log>>'},
				text : {text:'日记'},
				img : {src : 'img/48/task_log.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'日记'},
					temp1: {name:'temp1', label: '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.inputEditor();}}
				}},
			sms : {showType: 'image',type : 'mail',
				name : {text:'<<sms>>'},
				text : {text:'短信'},
				img : {src : 'img/48/task_sms.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'短信'},
					temp1: {name:'temp1', label: '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.inputEditor();}}
				}},
			sql : {showType: 'image',type : 'sql',
				name : {text:'<<sms>>'},
				text : {text:'短信'},
				img : {src : 'img/48/task_sql.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
