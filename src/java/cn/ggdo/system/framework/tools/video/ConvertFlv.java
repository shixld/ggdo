package cn.ggdo.system.framework.tools.video;
 ...
 * 类名：ConvertFlv 
 * 版本：1.0.0
 * 用途说明：将任意格式的视频转化为flv格式，有利于在线视频播放
 * 前置条件：安装MediaCoderE盘下放有 ffmpeg.exe、ffplay.exep、threadGC2.dll（ffmpeg来自 
 *   ffmpeg.rev12665.7z）
...
public class ConvertFlv {
	public static void main(String[] args) {
		ConvertFlv.convert("E:\\rmvb.rmvb", "E:\\假装情侣DVD中字.flv",
				"E:\\假装情侣DVD中字.jpg");
	}
